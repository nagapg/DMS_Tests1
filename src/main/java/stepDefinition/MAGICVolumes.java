...
public class MAGICVolumes {
	
	/** Declare variables */
	boolean bStatus;
	
	@Before public void beforeTest() {
		Reports.setTestCaseName("MAGICVolumes");
    }
...
if (bStatus) {
         Reports.logResults(LogStatus.PASS, "Test Pass", "MAGICVolumes");
    } 
	 else {
         Reports.logResults(LogStatus.FAIL, "Test Fail", "MAGICVolumes");
     } 
}
}
