...
public class TransmitToRMS {
	 private boolean bStatus=false;
	 
	 @Before
		public void setUp() throws Exception {
	    	alticor.magic.pages.Reports.setTestCaseName("Validating MA 6069");
		...
		GeneralFunctions.enterTextToElement(By.id("selectedAffLeftContainer"), "010");
	       ...
	       //Check the second check box//
	        ...
	        if (bStatus){
	         	  alticor.magic.pages.Reports.logResults(LogStatus.PASS, "Test Pass","FAA/INT checkboxes");
	         	  
	           }
	           else
	           {
	         	  alticor.magic.pages.Reports.logResults(LogStatus.FAIL, "Test Fail","FAA/INT checkboxes");
	           }
