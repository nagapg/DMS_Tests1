...
public class UserNotes_MBSponAll {
	...
	final private String sExpNote="Test Note";
	 ...
	 @Before
		public void setUp() throws Exception {
	    	alticor.magic.pages.Reports.setTestCaseName("Notes for MB Sponsor Change All");
    ...
    //Reporting//
    if (bStatus) {
        Reports.logResults(LogStatus.PASS, "Test Pass", "MB SC ALL Notes");

    } else {
        Reports.logResults(LogStatus.FAIL, "Test Fail", "MB SC ALL Notes");
    }
