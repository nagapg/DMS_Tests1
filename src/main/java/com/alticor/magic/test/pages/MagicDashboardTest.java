...
public class MagicDashboardTest {
    ...
    public void testPageTitle(){
        ...
        collector.checkThat("Page Title",
                driver.getTitle(),equalTo(dashboard.pageTitle()));
    }

    @Test
    public void testABOInfoSection(){
        MagicDashboard dashboard = new MagicDashboard(driver,null);
        collector.checkThat("ABO Info Bar Label",
                dashboard.aboInfoBarLabel().getText(),equalTo("Amway Business Owner Information"));
    }

    @Test
    public void testABOStatisticsSection(){
        MagicDashboard dashboard = new MagicDashboard(driver,null);
        collector.checkThat("ABO Statistics Bar Label",
                dashboard.aboStatisticsBarLabel().getText(),equalTo("Amway Business Owner Statistics"));
    }

    @Test
    public void testQuickGlanceSection(){
        MagicDashboard dashboard = new MagicDashboard(driver,null);
        collector.checkThat("Quick Glance Bar Label",
                dashboard.quickGlanceBarLabel().getText(),equalTo("Quick Glance"));
    }

    @Test
    public void testAwardQualifications(){
        MagicDashboard dashboard = new MagicDashboard(driver,null);
