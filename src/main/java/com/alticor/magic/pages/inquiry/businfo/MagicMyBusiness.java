...
public class MagicMyBusiness extends MagicPage {
    ...
    public DynamicElement globalMultiBusinessBarLabel(){
        return getDynamicElement().addSearch(By.xpath(".//*[@id='globalMultiBusCollapse']/div/span[1]"));
    }

    public DynamicElement internationalSponsoredBusinessBarLabel(){
        return getDynamicElement().addSearch(By.xpath(".//*[@id='intlSponBusExpand']/div[1]/span[1]"));
    }
}
